...
class _ScaffoldWithNavBarState extends State<ScaffoldWithNavBar>
  ...
  void didUpdateWidget(covariant ScaffoldWithNavBar oldWidget) {
    ...
    if (widget.branchIndex == oldWidget.branchIndex) return;

    // Set translation direction & run animation
    _direction = widget.branchIndex - oldWidget.branchIndex;
  ...
  @override
  Widget build(BuildContext context) {
    final dx = MediaQuery.of(context).size.width * 0.25;
    return Scaffold(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            return Transform.translate(
              offset: Offset(
                  _direction * (dx - dx * _translateAnimationController.value),
                  0),
              child: child,
            );
          },
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int branchIndex) => _onTap(context, branchIndex),
      ),
    );
  }

  /// Navigate to the current location of the branch at the provided branchIndex when
